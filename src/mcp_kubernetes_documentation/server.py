"""FastMCP server for Kubernetes documentation search and retrieval."""
...
DEFAULT_DB_PATH = Path(__file__).parent.parent.parent / "data" / "kubernetes_docs.db"

# Initialise FastMCP server
mcp = FastMCP(name="kubernetes-documentation")
...
def search_documentation(
    ...
    """Search Kubernetes documentation by keyword query.
    ...
    Args:
        ...
        section: Optional section to filter results. Common sections include:
                 'docs', 'blog', 'releases', 'announcements',
...
def read_documentation(path: str) -> str:
    """Read the full content of a specific Kubernetes documentation page.

    Args:
        path: The relative path to the documentation file (e.g.,
              'docs/concepts/overview/what-is-kubernetes.md' or
              'data/releases/schedule.yaml#1.35'). This path
