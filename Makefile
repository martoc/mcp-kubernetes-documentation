# Description: Makefile for Python MCP Kubernetes Documentation Server

PROJECT_NAME := mcp-kubernetes-documentation
TARGET := ./target
...
index: ## Build the documentation index
	...
	$(PYTHON) -m mcp_kubernetes_documentation.cli index

.PHONY: run
run: ## Run the MCP server
	@echo "==> Running MCP server..."
	$(PYTHON) -m mcp_kubernetes_documentation.server

DOCKER_IMAGE := mcp-kubernetes-documentation
